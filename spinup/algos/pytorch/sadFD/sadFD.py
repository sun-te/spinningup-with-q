...
from spinup.algos.pytorch.sadFD.core import DemoBuffer, ReplayBuffer
import spinup.algos.pytorch.sadFD.core as core
...
if __name__ == '__main__':
    ...
    parser.add_argument('--demo-file', type=str, default='data/demo1e5.pickle')
